...
def calc_timestep_contrail_evolution(
    ...
    **interp_kwargs : Any
    ...
    air_temperature_2_nosed = interpolate_met(met, contrail_2_nosed, "air_temperature", **interp_kwargs)
    if params["radiative_heating_effects"]:
    ...
    if humidity_scaling is not None:
        ...
        contrail_2_nosed["rhi"] = thermo.rhi(
            contrail_2_nosed["specific_humidity"], air_temperature_2_nosed, contrail_2_nosed["air_pressure"]
        )

    air_pressure_2_nosed = contrail_2_nosed["air_pressure"]
    specific_humidity_2_nosed = contrail_2_nosed["specific_humidity"]
    rho_air_2_nosed = thermo.rho_d(air_temperature_2_nosed, air_pressure_2_nosed)
